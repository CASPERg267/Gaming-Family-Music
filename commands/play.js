...
const { YOUTUBE_API_KEY, SOUNDCLOUD_CLIENT_ID, LOCALE, DEFAULT_VOLUME } = require("../util/GamingfamilyUtil");
...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (mobileScRegex.test(url)) {
      try {
        https.get(url, function (res) {
          if (res.statusCode == "302") {
            ...
            return message.reply("No content could be found at that url. By CASPER AG#7384").catch(console.error);
          }
        });
      } catch (error) {
        console.error(error);
      ...
      return message.reply("Following url redirection... By CASPER AG#7384").catch(console.error);
    }
